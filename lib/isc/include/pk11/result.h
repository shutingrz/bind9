...
#define PK11_R_INITFAILED      ISC_RESULTCODE_PK11(0)
#define PK11_R_NOPROVIDER      ISC_RESULTCODE_PK11(1)
#define PK11_R_NORANDOMSERVICE ISC_RESULTCODE_PK11(2)
#define PK11_R_NODIGESTSERVICE ISC_RESULTCODE_PK11(3)
#define PK11_R_NOAESSERVICE    ISC_RESULTCODE_PK11(4)
