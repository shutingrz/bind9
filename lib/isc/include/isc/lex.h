...
#define ISC_LEXOPT_EOL	     0x001 /*%< Want end-of-line token. */
#define ISC_LEXOPT_EOF	     0x002 /*%< Want end-of-file token. */
#define ISC_LEXOPT_INITIALWS 0x004 /*%< Want initial whitespace. */
#define ISC_LEXOPT_NUMBER    0x008 /*%< Recognize numbers. */
#define ISC_LEXOPT_QSTRING   0x010 /*%< Recognize qstrings. */
/*@}*/
 ...
 * characters.
 */
#define ISC_LEXOPT_DNSMULTILINE 0x020 /*%< Handle '(' and ')'. */
#define ISC_LEXOPT_NOMORE	0x040 /*%< Want "no more" token. */

#define ISC_LEXOPT_CNUMBER	    0x080  /*%< Recognize octal and hex. */
