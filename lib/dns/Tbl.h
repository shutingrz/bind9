...
//
void *
Tgetl(Tbl *tbl, const char *key, size_t klen);
void *
...
//
bool
Tgetkv(Tbl *tbl, const char *key, size_t klen, const char **rkey, void **rval);
...
//
Tbl *
Tsetl(Tbl *tbl, const char *key, size_t klen, void *value);
Tbl *
Tset(Tbl *tbl, const char *key, void *value);
Tbl *
Tdell(Tbl *tbl, const char *key, size_t klen);
Tbl *
...
//
Tbl *
Tdelkv(Tbl *tbl, const char *key, size_t klen, const char **rkey, void **rval);
...
//
bool
Tnextl(Tbl *tbl, const char **pkey, size_t *pklen, void **pvalue);
bool
...
Tdump(Tbl *tbl);
void
Tsize(Tbl *tbl, const char **rtype, size_t *rsize, size_t *rdepth,
      size_t *rbranches, size_t *rleaves);
